...
import { Mail, MapPin, Phone, Code, Zap, Shield, Users, ArrowRight, Menu, X, ChevronDown, MessageSquare } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-100 via-slate-50 to-slate-100 text-slate-900">
      ...
      <footer className="relative border-t-2 border-slate-300 bg-white/80 backdrop-blur-xl py-6 px-4">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="border-t-2 border-slate-300 pt-3 flex flex-col md:flex-row justify-between items-center text-xs text-slate-600 gap-2">
            <p>© 2025 Mantovani Tech. {t('footer.copyright')}</p>
      ...
      <a 
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 w-16 h-16 bg-gradient-to-br from-emerald-500 to-cyan-500 rounded-full flex items-center justify-center shadow-xl hover:shadow-emerald-500/50 transition-all duration-300 transform hover:scale-110 z-40"
